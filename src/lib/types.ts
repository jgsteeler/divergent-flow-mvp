...
export interface Item {
  ...
  keywords?: string[] // Parsed keywords for type inference and learning
}

export interface TypeLearningData {
  keywords: string[] // Keywords that indicate this type
  type: ItemType
  confidence: number
  timestamp: number
  wasCorrect?: boolean
  isDefault?: boolean // True for preloaded default phrases
}
